...
| Compare the validated 6.18 vendor path with maximum-mainline RK3588 support | [`../kernel-versions/`](../kernel-versions/README.md) -> [`maxline/board-support.md`](../kernel-versions/maxline/board-support.md) -> [`../status.md`](../status.md) track 13 |
...
| Maintain or refresh the maximum-mainline proposal integration | [`../kernel-versions/maxline/`](../kernel-versions/maxline/README.md) -> [`manifest.yaml`](../kernel-versions/maxline/manifest.yaml) -> [`public-series.tsv`](../kernel-versions/maxline/public-series.tsv) / [`wip-donors.tsv`](../kernel-versions/maxline/wip-donors.tsv) |
