...
| [`upstreaming-ledger.md`](upstreaming-ledger.md) | Cross-package submission decisions: which patches go to which upstreams, in what order, and which are deliberately never sent. Per-package detail lives in each project's `UPSTREAMING.md`. |
