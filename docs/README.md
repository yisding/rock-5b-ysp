...
| [`ppa-support.md`](ppa-support.md) | Share-facing guide for `ppa:yi-ding/ubuntu-rock-5b`: who should use it, why each package exists, use-case install profiles, support boundaries and evidence, and an area-by-area comparison with a Rockchip BSP distribution. |
