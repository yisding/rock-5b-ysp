...
| libmpp VP9 presentation-event repair | `github.com/yisding/mpp`, branch `ysp/main` | `a8b19653af1a0b23754afafd7de72919fa8d0c0c` (2026-08-05); distinct slot-queue occurrences plus owned show-existing frame snapshots. Public, Published in the normal PPA, installed, and hardware-validated through focused and broad gates | [`VP9 show-existing repair`](../findings/2026-08-04-libmpp-vp9-show-existing-reference-slot-leak.md#installed-ppa-package-closure) |
| libmpp (PPA packaging tree) | `github.com/yisding/mpp`, branch `ysp/main` | `a8b19653` (2026-08-05), eleven commits past `1.0.12@1375813c`; exported as `1.5.0+git20260805.a8b19653+ds-0ubuntu1~rk1` with unused Windows binaries removed. Source publication `18657949` is Published, arm64 build `33468629` succeeded, and the live-index runtime/development/demo packages are installed and replay-validated | [`packaging/ppa/README.md`](../packaging/ppa/README.md), [`VP9 show-existing repair`](../findings/2026-08-04-libmpp-vp9-show-existing-reference-slot-leak.md#installed-ppa-package-closure) |
