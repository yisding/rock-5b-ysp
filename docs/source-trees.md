...
| 14 | Maxline refresh trees | [update finding](../findings/2026-09-13-kernel-lines-updated-to-latest-upstreams.md), [2026-08-02 refresh finding](../findings/2026-08-02-rk3588-maxline-proposal-refresh.md) | current 7.3-rc2 pins plus the dated 2026-08-02 package and linux-next pins in §14 |
...
| Mainline rewrite Phase 3I clean terminal observations, 2026-08-09 | `rk3588-rewrite-mainline@38768c5cff4199d3016cda5af47811ce48620863` on `v7.2-rc6@075b74841bd0` | Phase 3H tip `e71d368cc483`; byte-identical clean-terminal observation checkpoint |
...
| Mainline rewrite Phase 3C selected-hardware owner, 2026-08-09 | `rk3588-rewrite-mainline@2ea836184b5f` on `v7.2-rc6@075b74841bd0` | Phase 3B tip `8439e3abc142`; byte-identical selected-hardware ownership checkpoint |
...
The Debian composite trees remain reconstructible:

| Composite | Base and layering |
|-----------|-------------------|
| `rk3588-rewrite-armbian-7.3-rc2@23383677d9809` | `v7.3-rc2@df2908090cda3` + Armbian build checkout `2a53f158` / snapshot `f57f0d57308eb`, then all 370 mainline rewrite commits |
...
The 7.3-rc2 composite is the current mainline package pin; the other two are
historical, predate the later reconciliation, and are package reconstruction
pins rather than validation evidence. None of the three carries a compile,
boot, or hardware result. Fetch the public `yisding/linux-rock5b` branches and
check out the hashes above; the Armbian snapshot commits live in the Armbian
build tree's bare kernel cache and are regenerated by
`./compile.sh kernel-patches-to-git`. Package metadata and build scripts own
any newer intended input.
...
## 14. Maxline refresh trees

The 2026-09-13 refresh, which is the current package input:

| Ref | Pin | Role |
|-----|-----|------|
| Torvalds base | `df2908090cda368b01ff43709f51890076c56157` | Linux 7.3-rc2 |
| Maxline public | `1e66ae0b4633f6a3de00b7bd705b10c45f44ff8a` | packaged public source, 248 commits |
| Maxline WIP | `7306d4ede54c9a78cebd3ed31156bdeecc57dc2d` | packaged FRL WIP source, +19 commits |

The superseded 2026-08-02 refresh captured:
