...
| 8 | Clean-room rewrite drivers | [rewrite-driver track](../kernel-drivers/docs/rewrite-drivers.md) | `yisding/linux-rock5b` branch `rk3588-rewrite-6.18` @ `9556beeb8ccf` + branch `rk3588-rewrite-mainline` @ `748151c2e3fa`, see §8 |
...
- branch `rk3588-rewrite-6.18`, commit `9556beeb8ccf` ("media: rockchip:
  support rga2 y4/y8 full csc"), matching the clean dev worktree
  `/home/yi/Code/linux-6.18-rkvenc`.
- branch `rk3588-rewrite-mainline`, commit `748151c2e3fa` (same subject),
...
Y4/Y8 dither-output coverage, BPP palette source coverage, and current
RGB-to-Y4/Y8 full-CSC dither-output coverage.
