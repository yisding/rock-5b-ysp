...
| 8 | Clean-room rewrite drivers | [rewrite-driver track](../kernel-drivers/docs/rewrite-drivers.md) | `yisding/linux-rock5b` branch `rk3588-rewrite-6.18` @ `faf525f56ca5` + branch `rk3588-rewrite-mainline` @ `3de52cd0585b`, see §8 |
...
- branch `rk3588-rewrite-6.18`, commit `faf525f56ca5` ("media: rockchip:
  cover rga configured request teardown"), matching the clean dev worktree
  `/home/yi/Code/linux-6.18-rkvenc`.
- branch `rk3588-rewrite-mainline`, commit `3de52cd0585b` (same subject),
...
acquire/release-fence coverage, mixed-task RGA3-to-RGA2 core
