...
| 8 | Clean-room rewrite drivers | [rewrite-driver track](../kernel-drivers/docs/rewrite-drivers.md) | `yisding/linux-rock5b` branch `rk3588-rewrite-6.18` @ `217f77b93fbb` + branch `rk3588-rewrite-mainline` @ `c618ab10a4ab`, see §8 |
...
- branch `rk3588-rewrite-6.18`, commit `217f77b93fbb` ("media: rockchip:
  cover mpp reset release cleanup"), matching the clean dev worktree
  `/home/yi/Code/linux-6.18-rkvenc`.
- branch `rk3588-rewrite-mainline`, commit `c618ab10a4ab` (same subject),
