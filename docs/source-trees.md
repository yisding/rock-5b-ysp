...
| 8 | Clean-room rewrite drivers | [rewrite-driver track](../kernel-drivers/docs/rewrite-drivers.md) | `yisding/linux-rock5b` branch `rk3588-rewrite-6.18` @ `dc2c66c77e22` + branch `rk3588-rewrite-mainline` @ `2bf046c6c4b1`, see §8 |
...
- branch `rk3588-rewrite-6.18`, commit `dc2c66c77e22` ("media: rockchip:
  cover rga3 afbc roundtrip"), matching the clean dev worktree
  `/home/yi/Code/linux-6.18-rkvenc`.
- branch `rk3588-rewrite-mainline`, commit `2bf046c6c4b1` (same subject),
...
RGB-to-Y4/Y8 full-CSC dither-output coverage, and AFBC-to-AFBC ffmpeg filter
copy coverage.
