...
| 8 | Clean-room rewrite drivers | [rewrite-driver track](../kernel-drivers/docs/rewrite-drivers.md) | shared rewrite sources `rk3588-rewrite-6.18@c5faabf9d00b0` and `rk3588-rewrite-mainline@7481ab327d7e`; dedicated AV1 source `rk3588-rewrite-av1-6.18@e58c57e50d0a0`; earlier package composites `rk3588-rewrite-armbian-6.18.38@8daf5e9513b8` and `rk3588-rewrite-armbian-7.2-rc3@24f7424fb958`; see §8 |
...
- branch `rk3588-rewrite-mainline`, commit `7481ab327d7e` ("media: rockchip:
  rga-rewrite: carry the 10-bit byte-stride ABI into TILE"), based on the tree
...
- branch `rk3588-rewrite-av1-6.18`, commit `e58c57e50d0a0` ("media:
  rockchip: harden AV1 DMA recovery"), in the isolated worktree
  ...
  implementation commits `3327030e09029`, `a5624fa024766`, and
  `402fc9c0bd785`, plus adversarial-repair commit `e58c57e50d0a0`. This is the
  source/build-verified AV1 line; it has no booted or board evidence yet. See
  the [adversarial validation record](../findings/2026-07-26-av1-rewrite-adversarial-validation.md).
