...
| 8 | Clean-room rewrite drivers | [rewrite-driver track](../kernel-drivers/docs/rewrite-drivers.md) | local branch `rk3588-rewrite-6.18` @ `1f551f8fd32e` + branch `rk3588-rewrite-mainline` @ `0ec942b2f0c5`, including invalid public scheduler-core mask KUnit coverage after the display-tail BGRA partial-alpha-blend, collector-level dormant MPP batch-server rejection, and Route B RGA3 userptr IOMMU mapping/debugfs attribution slices; see §8 |
...
- branch `rk3588-rewrite-6.18`, commit `1f551f8fd32e` ("media: rockchip:
  rga-rewrite: test invalid core masks"), committed in the dev worktree
...
- branch `rk3588-rewrite-mainline`, commit `0ec942b2f0c5` ("media: rockchip:
  rga-rewrite: test invalid core masks"),
...
(`../kernel/linux-6.18-rkvenc@1f551f8fd32e` and `../kernel/linux@0ec942b2f0c5`) passed that
archive build gate warning-free on 2026-07-06 after invalid scheduler-core
mask coverage was added; the same pins also passed
