...
| 8 | Clean-room rewrite drivers | [rewrite-driver track](../kernel-drivers/docs/rewrite-drivers.md) | `yisding/linux-rock5b` branch `rk3588-rewrite-6.18` @ `b7f192fa948e` + branch `rk3588-rewrite-mainline` @ `c99599fc7677`, see §8 |
...
- branch `rk3588-rewrite-6.18`, commit `b7f192fa948e` ("media: rockchip:
  cover rga request gauss reconfig"), matching the clean dev worktree
  `/home/yi/Code/linux-6.18-rkvenc`.
- branch `rk3588-rewrite-mainline`, commit `c99599fc7677` (same subject),
...
resource/acquire-fence/gauss replacement coverage, legacy async blit and modern
