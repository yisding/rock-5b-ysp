...
| 8 | Clean-room rewrite drivers | [rewrite-driver track](../kernel-drivers/docs/rewrite-drivers.md) | local branch `rk3588-rewrite-6.18` @ `861f4b80e146` + branch `rk3588-rewrite-mainline` @ `2c2254230865`, see §8 |
...
- branch `rk3588-rewrite-6.18`, commit `861f4b80e146` ("media: rockchip:
  cover mpp err-ref control"), committed in the dev worktree
  `/home/yi/Code/linux-6.18-rkvenc`.
- branch `rk3588-rewrite-mainline`, commit `2c2254230865` ("media: rockchip:
  cover mpp err-ref control"),
...
the current libmpp VDPU382 probe path, plus the
...
(`../linux-6.18-rkvenc@861f4b80e146` and `../linux@2c2254230865`) passed that
