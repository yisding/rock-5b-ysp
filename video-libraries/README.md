...
|---------|--------|-------|
| [`ffmpeg/`](ffmpeg/README.md) | `ffmpeg-rockchip` (upstream, 6.1-era base) and `ffmpeg-rockchip-81` (the port to FFmpeg 8.1.2): `h264_rkmpp`/`hevc_rkmpp` codecs, `scale_rkrga`/`vpp_rkrga` filters, rebase and fix series. | [`ffmpeg/`](ffmpeg/README.md) |
| [`vaapi/`](vaapi/README.md) | `rockchip-vaapi`: the libva backend over MPP/RGA, decode/encode capability boundaries, surface imports, browser sandbox policy, and evidence routes. | [`vaapi/`](vaapi/README.md) |
