...
| Historical FFmpeg 8.1/Kodi compatibility package | Full local arch+indep build, FATE, Launchpad arm64 build, and source publication | Removing decoder `pix_fmts` metadata preserves the RKMPP `hw_config`; missing `RELEASE_NOTES` and arch-dependent `ffmpeg-doc` were packaging defects, not codec defects | [Frozen package lessons](../../../packaging/ppa/README.md#ffmpeg81-package-lessons), [Kodi selection mechanism](../../../apps/kodi/docs/decoder-selection.md) |
