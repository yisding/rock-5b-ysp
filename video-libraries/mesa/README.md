...
| Current state | The `gl_FragCoord` u_blitter fix is upstream as the open 4-MR stack !42563 / !42679 / !42613 / !42614. The 2026-07-11 GitLab check found tips and pipelines unchanged and selected CI evidence still green; !42679 reported `need_rebase`. On 2026-07-22 a maintainer confirmed the varying failure is a hardware erratum and supplied a zero-valued depth-bias workaround, now verified for OpenGL and Vulkan raw varyings plus OpenGL ordinary TEX. On 2026-07-24 MR !43161's aspect-cutoff discussion was checked against a new triangle matrix reproducer; `1000` misses confirmed failures, and the affected set depends on actual blit triangle topology. See the [erratum finding](../../findings/2026-07-22-mali-varying-depth-bias-erratum-workaround.md), the [triangle matrix finding](../../findings/2026-07-24-mali-oblong-triangle-matrix.md), and [`status.md`](../../status.md). |
