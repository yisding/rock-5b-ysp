...
| `/home/yi/Code/rockchip-vaapi` | Reference clone of woodyst/rockchip-vaapi `@e8c64dd` (v1.0.11, LGPL-2.1), the PoC VA-API-over-MPP driver reviewed 2026-07-21. Fork candidate; verdict and probe order in [`findings/2026-07-21-rockchip-vaapi-driver-review.md`](../findings/2026-07-21-rockchip-vaapi-driver-review.md). Reconstructible by re-cloning GitHub. |
