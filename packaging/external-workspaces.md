...
| `/home/yi/Code/rockchip-vaapi` | Working checkout of the VA-API-over-MPP driver, forked to `yisding/rockchip-vaapi`. `origin` = upstream woodyst; `fork` = `git@github.com:yisding/rockchip-vaapi.git`, with active development and pushed checkpoints on `main` (latest recorded here: `03e6cb6`). Phase 0/1 are complete; Phase 2 has 7/8 HEVC Main vectors exact, generated plus pinned Main10/Profile 2 P010 gates exact, static HDR10 metadata green, and exact stock-GStreamer readback. Version `1.0.11+ysp3` builds safe split driver/config `.deb`s. Experimental one-slice H.264 Main/High and HEVC Main encode pass FFmpeg CQP/CBR/VBR, direct-I420 GStreamer `vah264enc`/`vah265enc`, parser, ASan/UBSan, and concurrent shipping-decode gates; HEVC requires the native MPP CTU64 contract, checked I420/YV12 uploads normalize into NV12, linear imported NV12 is submitted directly, one-object packed RGB DMA-BUFs pass a public-libva RGA conversion gate, H.264 reaches a WebRTC-compatible RTP boundary, and paced dual-codec soak smoke is resource-flat after fixing visible/aligned HEVC geometry. Firefox 152.0.6 has an exact-source-hash-pinned RDD policy patch covering the measured MPP/RGA requests and broker paths without disabling the sandbox; package build and live display validation remain. Profiles and encode remain honestly hidden where app/conformance boundaries are open. Source of truth is the fork remote, not this repo; see the [`Main10/P010`](../findings/2026-07-26-rockchip-vaapi-main10-afbc-p010-validation.md), [`H.264 encode`](../findings/2026-07-26-rockchip-vaapi-h264-va-encode-validation.md), [`HEVC encode`](../findings/2026-07-26-rockchip-vaapi-hevc-va-encode-validation.md), [`planar upload`](../findings/2026-07-26-rockchip-vaapi-planar-encode-upload-validation.md), [`DRM PRIME RGB import`](../findings/2026-07-26-rockchip-vaapi-drm-prime-rgb-encode-validation.md), [`WebRTC RTP`](../findings/2026-07-26-rockchip-vaapi-webrtc-rtp-validation.md), [`encode soak`](../findings/2026-07-26-rockchip-vaapi-dual-encode-soak-smoke.md), and [`Firefox RDD policy`](../findings/2026-07-26-firefox-rdd-rockchip-vaapi-policy.md) findings. Reconstructible by cloning the fork. |
