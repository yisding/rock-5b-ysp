...
| `/home/yi/Code/gnome/grd/gnome-remote-desktop` | GRD fork checkout used by the PPA helper. Public reconnect base `yding/rdp-handover-reconnect-v2@eb91daf476dc` remains fetchable; published `~exp3` exports `2571326322c754de7608ef4afb1dff8e4d031cbd`, hardware-tested readback tip `b3f0e20bc6e1` adds patch `0017`, and current ACK-resume/focus-idle candidate `yding/main@3e4480e066d30ba44015ae1b8cb3bbb92fe6414e` is represented by patches `0001`–`0019`. Local `exp8` applies format logger `0020`; local `exp9` also applies `0021`'s end-to-end audio trace and temporary no-Opus offer. The exact `~exp3` source is also recoverable from Launchpad publication `18626586`; see [`../docs/source-trees.md` §5](../docs/source-trees.md#5-gnome-remote-desktop-base). |
