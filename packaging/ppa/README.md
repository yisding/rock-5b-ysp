...
| forward-port kernel | `6.18.38+rk3588av1fwport20260709-0ubuntu1~rk2` under [`kernel-forward-port/`](kernel-forward-port/README.md) | Retry source publication `18614559` is `Pending`; arm64 build `33387391` is `Needs building`. Previous `~rk1` build `33387353` failed because `mkimage` was missing while generating `rockchip-fixup.scr`. | `~rk2` adds `u-boot-tools` to Build-Depends. Builds co-installable `linux-image-ysp-rockchip64`, `linux-dtb-ysp-rockchip64`, and `linux-headers-ysp-rockchip64`; board install/revert validation is still pending. |
| alpha rewrite kernel 6.18 | `6.18.0+rk3588rewritealpha20260710-0ubuntu1~rk2` under [`kernel-rewrite-alpha-6.18/`](kernel-rewrite-alpha-6.18/README.md) | Retry source publication `18614560` is `Pending`; arm64 build `33387392` is `Needs building`. Previous `~rk1` source `18614549` is `Published`, with build `33387366` still running at the last check. | `~rk2` adds `u-boot-tools` to Build-Depends. Builds co-installable `linux-image-ysp-alpha-6.18-rockchip64`, `linux-dtb-ysp-alpha-6.18-rockchip64`, and `linux-headers-ysp-alpha-6.18-rockchip64`; board validation is pending. |
| alpha rewrite kernel 7.2-rc2 | `7.2.0~rc2+rk3588rewritealpha20260710-0ubuntu1~rk2` under [`kernel-rewrite-alpha-7.2-rc2/`](kernel-rewrite-alpha-7.2-rc2/README.md) | Retry source publication `18614561` is `Pending`; arm64 build `33387393` is `Needs building`. Previous `~rk1` source `18614550` is `Published`, with build `33387367` still running at the last check. | `~rk2` adds `u-boot-tools` to Build-Depends. Built from `rk3588-rewrite-mainline` rebased to official kernel.org `v7.2-rc2` at `083bdb98e715`; board validation is pending. |
...
`~rk3` retry is still queued/rebuilding and the kernel `~rk2` retries are queued,
