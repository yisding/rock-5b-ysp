...
| Upload state | Signed and uploaded to `ppa:yi-ding/ubuntu-rock-5b`; Launchpad source publication `18614549` is `Pending`, and arm64 build `33387366` is `Needs building`. |
...
- `dput ppa:yi-ding/ubuntu-rock-5b` completed client-side upload of the signed
  source package.
- Launchpad API check on 2026-07-10 23:05 PDT found source publication `18614549`
  in `Pending` state and arm64 build `33387366` in `Needs building` state.
