...
> **Historical design record.** This captures the proposal analysis and
> integration plan that produced the pinned `public` and `wip` profiles on
> 2026-07-17. Do not treat the revision labels or proposal inventory below as
