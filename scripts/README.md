...
| [`check-doc-consistency.py`](check-doc-consistency.py) | Checks README ownership, finding metadata/index order, dashboard/next-gate/ledger alignment, watchlist index/detail contracts, and stable support-coverage rows. |
