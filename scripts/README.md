...
| [`check-doc-consistency.py`](check-doc-consistency.py) | Checks README ownership and project briefs, finding metadata/index order, dashboard/next-gate/ledger alignment, watchlist index/detail contracts, stable support-coverage rows, and selected load-bearing terminology invariants. |
