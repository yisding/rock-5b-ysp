...
The kernel docs ([kernel driver guide](../../kernel-drivers/docs/how-the-drivers-work.md)) and uAPI docs
([uAPI guide](../../kernel-drivers/docs/dev-uapis.md)) explain what happens after libmpp/librga
