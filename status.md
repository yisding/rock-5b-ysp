...
| 4 | Clean-room rewrite drivers | 🚧 The follow-up boot reports 85/85 MPP and 147/147 RGA KUnit results green, but three passing RGA fixtures misuse ordinary work/timer initializers on six embedded stack objects; Debug Objects prints only five reports because its stack-mismatch warning is capped at five. Intended rewrite MPP cores and RGA2 bind; both RGA3 cores reach `request_irq()` but conflict with the paired IOMMUs' shared lines. The shared-IRQ repair/refinement are committed as 6.18 `bc420aca1300e..eb64bc7de3270` and mainline `d28fdd9c75694..6ac18425f66c7`; the fixture owners are now KUnit-managed heap objects at 6.18 `4273266a990ef` and mainline `ef79d16bd9020`. The current tips add a dedicated 148th RGA case. The DWC PCIe PMU false positive separately disables lockdep. Package/boot proof of a warning-clean 85+148 run, fixed RGA3 binding, and ABI/media ioctls remain open. | 2026-07-26 | [KUnit, warning, and binding follow-up](./findings/2026-07-26-rewrite-kunit-gate-passes.md), [DWC PCIe PMU warning](./findings/2026-07-26-dwc-pcie-pmu-bus-notifier-lockdep-false-positive.md) |
...
| 4 | Clean-room rewrite drivers | Package and boot the committed debug-object fixture and RGA3 shared-IRQ repairs. Require 85/85 MPP plus the new 148/148 RGA plan with no debug-object report, eliminate the DWC PCIe PMU report so lockdep remains enabled, and prove RGA2 plus both RGA3 cores bind. Then run isolated ABI replay with clean dmesg and readable debugfs before resuming paired counter/artifact conformance. | [KUnit warning, binding failure, and next gate](./findings/2026-07-26-rewrite-kunit-gate-passes.md#next-gate), [DWC PCIe PMU warning](./findings/2026-07-26-dwc-pcie-pmu-bus-notifier-lockdep-false-positive.md#qualification-impact), [remaining rewrite hardware gates](./kernel-drivers/docs/rewrite-conformance-gap-audit.md#remaining-gaps-and-hardware-gates) |
