...
| 4 | Clean-room rewrite drivers | 🚧 Build `#6` passes the complete 85/85 MPP + 148/148 RGA KUnit plans and proves the shared-IRQ repair: RGA2 and both RGA3 cores bind. It exposes two Debug Objects reports in the passing timeout-replacement fixture, correcting the previous accounting to eight ordinary work/timer objects across four stack fixtures; the five-report cap had hidden this final delayed-work pair. Both maintained trees now move that owner to KUnit-managed heap storage at 6.18 `3b41eca277c7` and mainline `52d4dfa16825`; focused compilation and both exact clean-archive normal profiles pass warning-free. The DWC PCIe PMU false positive still disables lockdep before KUnit. Package/boot proof of a warning-clean 85+148 run and ABI/media ioctls remain open. | 2026-07-27 | [final capped KUnit fixture](./findings/2026-07-27-rewrite-kunit-final-stack-fixture.md), [DWC PCIe PMU warning](./findings/2026-07-26-dwc-pcie-pmu-bus-notifier-lockdep-false-positive.md) |
...
| 4 | Clean-room rewrite drivers | Package and boot current 6.18 tip `dbc36621b301` (which contains final-fixture fix `3b41eca277c7`), with the optional DWC PCIe PMU disabled for the qualification experiment. Require 85/85 MPP plus 148/148 RGA with no debug-object or other fatal report, confirm lockdep remains enabled, and retain the now-proven RGA2 + two-RGA3 binding. Then run isolated ABI replay with clean dmesg and readable debugfs before resuming paired counter/artifact conformance. | [final fixture fix and next gate](./findings/2026-07-27-rewrite-kunit-final-stack-fixture.md#next-gate), [DWC PCIe PMU warning](./findings/2026-07-26-dwc-pcie-pmu-bus-notifier-lockdep-false-positive.md#qualification-impact), [remaining rewrite hardware gates](./kernel-drivers/docs/rewrite-conformance-gap-audit.md#remaining-gaps-and-hardware-gates) |
