...
| Mesa MR [!38433](https://gitlab.freedesktop.org/mesa/mesa/-/merge_requests/38433) / [!42563](https://gitlab.freedesktop.org/mesa/mesa/-/merge_requests/42563) merge state | Local branches rebase onto whatever lands | 2026-07-01 | Both `state: opened` per authenticated `glab api` from the board (web UI stays bot-blocked; unauthenticated API 401s on notes — use `glab api "projects/176/merge_requests/<iid>/notes"`) |
