...
| 4 | Clean-room rewrite drivers | 🚧 `P3138-Cad24` proved the lifecycle repair but exposed one fixture mutex warning that disabled lockdep and one 2,048-byte fixture allocation to kmemleak. Both are fixed at 6.18 `6b55e022ce49` and byte-identical mainline `9aa6ef7e97b2`; pinned 6.18.40 KASAN/lockdep package `Pe8c5-Cad24` is built and payload-verified for the clean compound retest. | 2026-07-27 | [lockdep/kmemleak attribution, repair, and package](./findings/2026-07-27-rewrite-kunit-lockdep-kmemleak-fixtures.md) |
...
| 4 | Clean-room rewrite drivers | Boot `Pe8c5-Cad24`; require exact 233-case KTAP, no fatal KUnit-interval line, live lockdep, a clean aged kmemleak scan, restored runtimes and every expected core before isolated ABI replay and full conformance. | [compound next gate](./findings/2026-07-27-rewrite-kunit-lockdep-kmemleak-fixtures.md#boundary-and-next-gate) |
