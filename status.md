...
| 14 | Desktop-app HW video (browsers) | Install the built `rockchip-vaapi 1.0.11+ysp4` packages and re-run the decode, VLC and Firefox gates against the installed driver with no `LIBVA_DRIVERS_PATH` override. | [Verification gate](./findings/2026-07-28-vaapi-shipping-stack-gates-hevc-main-and-vlc-firefox-decode.md#verification-gate) |
