...
| 4 | Clean-room rewrite drivers | 🚧 The boot-KUnit lifecycle wedge is root-caused and fixed in both rewrite trees; all six clean-archive build profiles pass, and repaired KASAN/lockdep package `P3138-Cad24` is payload-verified. A clean 233-case boot, live lockdep, reprobe, ABI replay, and media-ioctl proof remain open. | 2026-07-27 | [KUnit lifecycle root cause and repaired package](./findings/2026-07-27-rewrite-kunit-boot-lifecycle-wedge.md) |
...
| 4 | Clean-room rewrite drivers | Boot `P3138-Cad24`; require clean unregister → 233-case KUnit → reprobe, live lockdep, all RGA cores bound, then an isolated ABI replay with clean dmesg. | [package fingerprint and next gate](./findings/2026-07-27-rewrite-kunit-boot-lifecycle-wedge.md#next-gate) |
