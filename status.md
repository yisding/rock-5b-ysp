...
| 4 | Clean-room rewrite drivers | 🚧 Kernel #8 at `gf37186832202` booted and exposed residual decoder and RGA3 failures. The provisional Phase 1 boundary is source-complete, and the operator explicitly authorized source-only Phase 2 work without waiting for boot qualification. Maintained tips 6.18 `e99b3da2f3318` and mainline `63bbb63bec44d` retain stable reset domains and cluster topology, own the hard-CCU pulse, member-power lease, coordinator list/link, and soft/hard publication, and now route every single-core reset plus idle IOMMU fault through one typed quiesced/reusable result. Reset success refreshes translations before reuse; terminal isolation retires without soft-CCU reconnect. Hard-CCU group DMA completion and descriptor admission remain later checkpoints. They pass strict checkpatch, byte identity, exact 100 MPP + 152 RGA manifests, the 992-signal production ownership inventory, and the unchanged 306-signal KUnit-debt audit. Warning-fatal KUnit-enabled MPP object builds pass at both exact tips; the complete eight-profile clean-archive matrix belongs to the preceding `53a7fa1acbc00` / `ba8e11de18a8e` reset-domain checkpoint. This is compile/source evidence only. The predecessor exact 6.18 package P692f with source stamp `(gab69ece99864)` remains uninstalled and unbooted; no package or boot contains Phase 2. Runtime KUnit, decoder/reset-contention/recovery, solo RGA3 vpp, overlay-chain, AV1/VSI, performance, fuzz, and soak qualification remain open. The separate RGA2 plain-system-heap 1 MiB SWIOTLB staging design remains deliberately unimplemented while active ownership changes. | 2026-08-08 | [single-core recovery result](./findings/2026-08-08-rewrite-phase-2-single-core-recovery-result.md), [cluster CCU ownership](./findings/2026-08-08-rewrite-phase-2-cluster-ccu-ownership.md), [cluster power lease](./findings/2026-08-08-rewrite-phase-2-cluster-power-lease.md), [group-reset ownership](./findings/2026-08-08-rewrite-phase-2-hard-ccu-reset-ownership.md), [cluster construction](./findings/2026-08-08-rewrite-phase-2-cluster-construction.md), [reset-domain construction](./findings/2026-08-08-rewrite-phase-2-reset-domain-construction.md), [Phase 1 build finding](./findings/2026-08-08-rewrite-phase-1-focused-build-gate.md), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md), [rga3 vpp corruption](./findings/2026-08-07-rga3-cross-process-vpp-corruption-lead.md), [overlay-chain gaps](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md) |
...
| 4 | Clean-room rewrite drivers | Extend the typed recovery result across hard-CCU group reset: deduplicate the reference-pinned participants' DMA groups and forbid resend/admission until every affected group is refreshed or terminally isolated. Keep the source-only boundary explicit: separately build/package/install/boot the exact tip, require all 252 KUnit cases and a fatal-free lockdep interval, and replay same-session H.26x, dual-core reset contention/recovery, solo RGA3 vpp, and overlay-chain cases. IRQ epochs and terminal arbitration still wait for their later retained generation-tagged activation/task-execution owners. | [single-core recovery boundary](./findings/2026-08-08-rewrite-phase-2-single-core-recovery-result.md#boundary-and-next-gate), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA3 fixed-tip gate](./findings/2026-08-08-rga3-cross-process-contention-harness-plan.md#verification-gate), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md#verification-gate), [overlay-chain boundary](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md#boundary), [rewrite validation plan](./kernel-drivers/docs/rewrite-validation-plan.md) |
