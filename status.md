...
| 9 | Launchpad PPA | Build and publish a 6.18.43 successor carrying `0093`–`0096`, install it with recovery retained, and close its full conformance, alias-staging, ownership, fault-admission, and soft-CCU fallback gates; then install exact Published FFmpeg and replay its GRD integration gate. | [0095–0096 verification gate](./findings/2026-08-08-forward-port-rga-mpp-ownership-audit-fixes.md#verification-gate), [W05 publication record](#watch-w05), [FFmpeg integration gate](./findings/2026-07-30-ffmpeg-rkmpp-async-frame-lifetime-fix.md#verification-gate) |
...
- **State 2026-08-08:** `6.18.43-ysp-rockchip64` (source
  ...
  staging, RGA/MPP lifetime, provider-admission, and soft-CCU fallback fixes but
  is not packaged or booted. See W26,
