...
| 4 | Clean-room rewrite drivers | Re-export an alpha package from a hardened tip, boot it on the board, and capture the first hardware conformance log. | [Rewrite acceptance commands](./kernel-drivers/tests/rewrite-conformance.md#rewrite-acceptance-one-command) |
