...
| 4 | Clean-room rewrite drivers | 🚧 MPP ownership-refactor Phase 3 is source-complete at 6.18 `77b60c9250ccccd8aa77c4b4426b7921e870a03d` and mainline `0a645ea1df04225661e9611174abe3ca1451b07f`. Each activation now owns its attempt-bounded CCU/link/DCHS/power/timing resources, coherent hard-CCU retry handoff, stable-priority terminal arbitration, exact drain/core/dispatch release, sole successful `DONE` publication, and `RECLAIMABLE` retirement; quarantine stays fail-closed and resource-retaining. The byte-identical MPP source SHA-256 is `33a0374b2009cb70a688cd02bfbc501b93fedb68a90d52db4ec654f82dc94f4e`; strict checkpatch is 0/0/0 over 3,253 lines/tree. Ownership passes at 2,314/tree, fixture debt at 306/tree, and the manifest is 108 MPP + 152 RGA = 260 cases. All eight warning-fatal profiles and the dedicated test-disabled ABI-mutation gate pass on both lines. No package or boot contains Phase 2 or Phase 3, so exact-tip KUnit, decoder/reset/recovery, RGA3, overlay, AV1/VSI, sanitizer, performance, fuzz, and soak qualification remain open. The separate RGA2 1 MiB SWIOTLB staging design remains deliberately unimplemented. | 2026-08-09 | [Phase 3 completion](./findings/2026-08-09-rewrite-phase-3-complete-mpp-activation-retirement.md), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md), [RGA3 fixed-tip gate](./findings/2026-08-08-rga3-cross-process-contention-harness-plan.md), [overlay-chain gaps](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md) |
...
| 4 | Clean-room rewrite drivers | Build/package/install/boot the exact Phase 3 tips, require all 260 KUnit cases and a fatal-free lockdep interval, then force reason-order permutations, resource handoff/reclaim, retry/quarantine balance, exact clean and recovered observations, AV1 untrusted-stop retention/retry, same-session H.26x, dual-core reset contention/recovery, solo RGA3 vpp, and overlay-chain cases. | [Phase 3 runtime gate](./findings/2026-08-09-rewrite-phase-3-complete-mpp-activation-retirement.md#boundary-and-next-gate), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA3 fixed-tip gate](./findings/2026-08-08-rga3-cross-process-contention-harness-plan.md#verification-gate), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md#verification-gate), [overlay-chain boundary](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md#boundary), [rewrite validation plan](./kernel-drivers/docs/rewrite-validation-plan.md) |
