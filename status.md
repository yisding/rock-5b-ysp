...
| 4 | Clean-room rewrite drivers | Build and boot exact-tip 6.18 `571e261b26f79`, then require exact KUnit/MPP plus the DMA-BUF reroute and USERPTR zero-failure counter contract in the corrected librga suite. | [RGA2 bounce verification gate](./findings/2026-08-05-rewrite-rga2-dmabuf-userptr-bounce-followup.md#boundary-and-verification-gate), [rewrite validation plan](./kernel-drivers/docs/rewrite-validation-plan.md) |
