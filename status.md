...
| 4 | Clean-room rewrite drivers | 🚧 Kernel #8 at `gf37186832202` booted and exposed residual decoder and RGA3 failures. The operator explicitly authorized source-only Phase 2/3 work without waiting for boot qualification. Maintained tips 6.18 `7481df21ca2b1481a3c4b4d222e3ebed28692544` and mainline `4a632e00c4cd729cb7aa473686bed3ccd2bb271c` retain the earlier owners and add Phase 3J's typed `{activation, generation}` external references plus the KUnit-only stack-shape correction. Active, claim, timeout, retry, and quarantine owners now hold paired activation/job references with clone/move/put semantics and a base-biased retained activation lifetime. Dispatch/current/list identities remain borrowed and backend resources remain job-shaped. Phase 3I's exact clean observations, advisory RKVDEC `BUS_IDLE`, separate recovered proof, and AV1 untrusted-stop retained-slot behavior are unchanged. There is still no `RECLAIMABLE`, resource drain, final outcome arbitration, or runtime claim. The byte-identical MPP source SHA-256 is `815ccaf6daa20a88592f1b9ba4860a29aeb35e2a26cae7554ade714420e29ee4`; strict full-series checkpatch is 0/0/0 over 1,976 lines/tree. The final-source 6.18 KUnit-enabled object is 6,559,584 bytes at SHA-256 `8bd96a7ccb3fa60cfa23203055a0404b3f26d4dbd3e93a0b28224748cb7e337d`; the test-disabled object is 2,287,288 bytes at SHA-256 `4c7d90ba06743683c5b291e9b8d0dbfc910673cbf4c2a371f251de9c0ce98286`. Ownership passes at 2,251/tree, fixture debt at 306/tree, and the manifest is 105 MPP + 152 RGA = 257 cases. All eight warning-fatal final-head profiles pass across both lines with both IOMMU providers, both rewrite objects, and the Rock 5B DTB. The dedicated test-disabled policy/ABI gate also passes on both heads: both KUnit options resolve disabled, the providers/rewrite objects/DTB compile warning-fatally, and the deliberate MPP ABI mutation fails at compile time. The repository-wide handoff gate passes; runtime results remain pending, and the Phase 3I results remain historical. The predecessor exact 6.18 package P692f with source stamp `(gab69ece99864)` remains uninstalled and unbooted; no package or boot contains Phase 2 or Phase 3. Runtime KUnit, decoder/reset-contention/recovery, solo RGA3 vpp, overlay-chain, AV1/VSI, performance, fuzz, and soak qualification remain open. The separate RGA2 plain-system-heap 1 MiB SWIOTLB staging design remains deliberately unimplemented while active ownership changes. | 2026-08-09 | [Phase 3J typed activation references](./findings/2026-08-09-rewrite-phase-3j-mpp-typed-activation-references.md), [Phase 3I clean terminal observations](./findings/2026-08-09-rewrite-phase-3i-mpp-clean-terminal-observations.md), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md), [rga3 vpp corruption](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md), [overlay-chain gaps](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md) |
...
| 4 | Clean-room rewrite drivers | Build/package/install/boot the exact Phase 3J tip, require all 257 KUnit cases and a fatal-free lockdep interval, and force typed-reference retry/quarantine balance plus all three exact clean observations, impossible-finisher quarantine, AV1 untrusted-stop retention/retry, restore-refusal quarantine, same-session H.26x, dual-core reset contention/recovery, solo RGA3 vpp, and overlay-chain cases. Before outcome arbitration or base-bias release, define activation-aware resource drain and permit `RECLAIMABLE` only after every external and backend resource owner is demonstrably gone. | [Phase 3J boundary](./findings/2026-08-09-rewrite-phase-3j-mpp-typed-activation-references.md#boundary-and-next-gate), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA3 fixed-tip gate](./findings/2026-08-08-rga3-cross-process-contention-harness-plan.md#verification-gate), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md#verification-gate), [overlay-chain boundary](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md#boundary), [rewrite validation plan](./kernel-drivers/docs/rewrite-validation-plan.md) |
