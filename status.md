...
| 4 | Clean-room rewrite drivers | 🚧 Kernel #8 at `gf37186832202` booted and exposed residual decoder and RGA3 failures. The operator explicitly authorized source-only Phase 2/3 work without waiting for boot qualification. Maintained tips 6.18 `395644689db8f` and mainline `38768c5cff419` retain the Phase 2 owners plus Phase 3A–I activation checkpoints. Phase 3I records exact `NOT_PUBLISHED`, `IRQ_ACCEPTED`, or `CCU_DONE_ACCEPTED` terminal observations and makes the corresponding claim immutable `RETIRED`; the legacy `CLAIMED` fallback is gone. RKVDEC `BUS_IDLE` status is advisory evidence, not quiescence or reuse authority; recovered terminal proof and restore-refusal quarantine remain separate. An AV1 untrusted-stop failure deliberately retains `SLOTTED` active ownership for remove/shutdown retry. There is still no `RECLAIMABLE`, resource drain, final outcome arbitration, or runtime claim. The MPP source SHA-256 is `95816d9033e76c86638e13b5ed3a0399b4a30e9d26b338579a624548fcecaada`; strict full-series checkpatch is 0/0/0 over 1,076 lines; focused KUnit-enabled MPP objects and all eight warning-fatal clean-archive profiles compile across both lines; ownership is 2,180 signals/tree; fixture debt is 306/tree; and the source manifest is exactly 104 MPP + 152 RGA = 256 cases. The repository-wide handoff gate passes; runtime execution remains pending. The predecessor exact 6.18 package P692f with source stamp `(gab69ece99864)` remains uninstalled and unbooted; no package or boot contains Phase 2 or Phase 3. Runtime KUnit, decoder/reset-contention/recovery, solo RGA3 vpp, overlay-chain, AV1/VSI, performance, fuzz, and soak qualification remain open. The separate RGA2 plain-system-heap 1 MiB SWIOTLB staging design remains deliberately unimplemented while active ownership changes. | 2026-08-09 | [Phase 3I clean terminal observations](./findings/2026-08-09-rewrite-phase-3i-mpp-clean-terminal-observations.md), [Phase 3H recovered-terminal quarantine](./findings/2026-08-09-rewrite-phase-3h-mpp-recovered-terminal-quarantine.md), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md), [rga3 vpp corruption](./findings/2026-08-07-rga3-cross-process-vpp-corruption-lead.md), [overlay-chain gaps](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md) |
...
| 4 | Clean-room rewrite drivers | Build/package/install/boot the exact Phase 3I tip, require all 256 KUnit cases and a fatal-free lockdep interval, and force all three exact clean observations, impossible-finisher quarantine, AV1 untrusted-stop retention/retry, restore-refusal quarantine, same-session H.26x, dual-core reset contention/recovery, solo RGA3 vpp, and overlay-chain cases. Before outcome arbitration, define activation-aware resource drain and permit `RECLAIMABLE` only after every async/resource owner is demonstrably gone. | [Phase 3I boundary](./findings/2026-08-09-rewrite-phase-3i-mpp-clean-terminal-observations.md#boundary-and-next-gate), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA3 fixed-tip gate](./findings/2026-08-08-rga3-cross-process-contention-harness-plan.md#verification-gate), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md#verification-gate), [overlay-chain boundary](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md#boundary), [rewrite validation plan](./kernel-drivers/docs/rewrite-validation-plan.md) |
