...
| 4 | Clean-room rewrite drivers | 🚧 Kernel #8 at `gf37186832202` booted and exposed residual decoder and RGA3 failures. The provisional Phase 1 boundary is source-complete, and the operator explicitly authorized source-only Phase 2 work without waiting for boot qualification. Maintained tips 6.18 `ab9f6e2d2023f` and mainline `5890133da0c46` retain stable reset domains and cluster topology; own the hard-CCU pulse, member-power lease, coordinator list/link, and soft/hard publication; and route single-core and hard-CCU group recovery through typed quiesced/reusable results. Hard recovery refreshes every affected DMA group before reuse. START now publishes an IRQ-safe register lease tied to reset epoch and, for direct-core work, active generation; reset and final register-power release revoke it, while threaded IRQ handling rejects absent or stale records. Descriptor admission remains unchanged. The tips pass strict checkpatch, byte identity, exact 102 MPP + 152 RGA manifests, the 1186-signal production ownership inventory, the unchanged 306-signal KUnit-debt audit, and all eight warning-fatal clean-archive `normal`, `test-disabled`, `memory`, and `race` profiles. This is compile/source evidence only. The predecessor exact 6.18 package P692f with source stamp `(gab69ece99864)` remains uninstalled and unbooted; no package or boot contains Phase 2. Runtime KUnit, decoder/reset-contention/recovery, solo RGA3 vpp, overlay-chain, AV1/VSI, performance, fuzz, and soak qualification remain open. The separate RGA2 plain-system-heap 1 MiB SWIOTLB staging design remains deliberately unimplemented while active ownership changes. | 2026-08-08 | [IRQ/register epoch lease](./findings/2026-08-08-rewrite-phase-2-irq-register-epoch-lease.md), [hard-CCU DMA recovery](./findings/2026-08-08-rewrite-phase-2-hard-ccu-dma-recovery.md), [single-core recovery result](./findings/2026-08-08-rewrite-phase-2-single-core-recovery-result.md), [cluster CCU ownership](./findings/2026-08-08-rewrite-phase-2-cluster-ccu-ownership.md), [cluster power lease](./findings/2026-08-08-rewrite-phase-2-cluster-power-lease.md), [group-reset ownership](./findings/2026-08-08-rewrite-phase-2-hard-ccu-reset-ownership.md), [cluster construction](./findings/2026-08-08-rewrite-phase-2-cluster-construction.md), [reset-domain construction](./findings/2026-08-08-rewrite-phase-2-reset-domain-construction.md), [Phase 1 build finding](./findings/2026-08-08-rewrite-phase-1-focused-build-gate.md), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md), [rga3 vpp corruption](./findings/2026-08-07-rga3-cross-process-vpp-corruption-lead.md), [overlay-chain gaps](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md) |
...
| 4 | Clean-room rewrite drivers | Build/package/install/boot the exact IRQ/register-lease tip, require all 254 KUnit cases and a fatal-free lockdep interval, and replay same-session H.26x, dual-core reset contention/recovery, solo RGA3 vpp, and overlay-chain cases. Do not begin terminal-reason arbitration until the generation-tagged activation object can retain and close a retiring snapshot. | [IRQ/register epoch boundary](./findings/2026-08-08-rewrite-phase-2-irq-register-epoch-lease.md#boundary-and-next-gate), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA3 fixed-tip gate](./findings/2026-08-08-rga3-cross-process-contention-harness-plan.md#verification-gate), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md#verification-gate), [overlay-chain boundary](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md#boundary), [rewrite validation plan](./kernel-drivers/docs/rewrite-validation-plan.md) |
