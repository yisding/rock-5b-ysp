...
| 4 | Clean-room rewrite drivers | 🚧 Ownership-refactor Phases 4 and 5 are source-complete at 6.18 `149a9ecd38f78daec7a2c6f8c6010e55ea8ad252` and mainline `280181e634a3a10a3a4f1659fe7c7287f7ee3760`. RGA now gives every hardware task typed execution/generation ownership, exact retirement or resource-retaining quarantine, and a sole whole-job orchestrator. MPP command images are sealed before const backend validation/dispatch, all implemented RGA emitters consume immutable task plans, and owner-specific START paths publish ownership and watchdogs before the doorbell. The byte-identical source SHA-256 values are MPP `45a8de124ec94b28f85fd117658e560b5c9bee096a7f610bbd04b59a1b97cade` and RGA `0003a3912d2fabf0b9f3292b49f35171c78db16f1cb6407b784a4aee8ab2ae2d`; strict checkpatch reports zero errors and warnings with 76 style checks. Ownership passes at 2,312/tree, fixture debt at 306/tree, and the manifest is 109 MPP + 152 RGA = 261 cases. All eight warning-fatal profiles and the dedicated test-disabled ABI-mutation gate pass on both lines. No package or boot contains Phases 2–5, so exact-tip KUnit, terminal/failpoint/fallback/copyback, byte-exact artifact differential, decoder/reset/recovery, RGA3, overlay, AV1/VSI, sanitizer, performance, fuzz, and soak qualification remain open. The separate RGA2 1 MiB SWIOTLB staging design remains deliberately unimplemented. | 2026-08-11 | [Phase 4/5 completion](./findings/2026-08-11-rewrite-phases-4-5-task-execution-and-sealed-emission.md), [ownership refactor plan](./kernel-drivers/docs/rewrite-ownership-refactor-plan.md), [RGA2 staging design](./findings/2026-08-08-rewrite-rga2-dmabuf-staging-design.md), [RGA3 fixed-tip gate](./findings/2026-08-08-rga3-cross-process-contention-harness-plan.md), [overlay-chain gaps](./findings/2026-08-07-rewrite-rga-blend-chain-swiotlb-and-rga3-iommu-fault.md) |
