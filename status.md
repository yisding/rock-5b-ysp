...
| 4 | Clean-room rewrite drivers | 🚧 The maintained 6.18 and mainline sources are aligned and build cleanly. An exact-tip 6.18 KASAN package exists but is unbooted; predecessor hardware evidence exposed RGA defects that are fixed only in the new, runtime-unverified tips. Current-tip KUnit, librga, AV1/VSI, recovery, performance, fuzz, and soak qualification remain open. | 2026-08-05 | [latest build/fix finding](./findings/2026-08-05-rewrite-rga-librga-swiotlb-fence-status.md), [architecture guide](./kernel-drivers/docs/rewrite-driver-architecture/README.md) |
...
| 4 | Clean-room rewrite drivers | Boot the exact-tip 6.18 KASAN package and require the complete KUnit manifest plus corrected librga before continuing through the maintained qualification plan. | [librga verification gate](./findings/2026-08-05-rewrite-rga-librga-swiotlb-fence-status.md#boundary-and-verification-gate), [rewrite validation plan](./kernel-drivers/docs/rewrite-validation-plan.md) |
