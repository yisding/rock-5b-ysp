...
- **State then:** Diagnostic `~exp2` and recovery `~exp3` narrowed the original
  ...
  package build; install/live validation, publication/promotion, and an
  upstream GNOME review remain.
