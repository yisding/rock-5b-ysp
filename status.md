...
| 5 | ffmpeg tree | ⚠️ The asynchronous RKMPP frame-lifetime fix passes its focused gates, but full-suite replay on rewrite KASAN intermittently corrupts H.264 or HEVC decode output after the first exact frame; immediate focused repeats are clean and the MPP revision differential is non-deterministic. Its published/install state belongs to [W05](#watch-w05); installed-package GRD fallback/recreation and AV1 container validation remain open. | 2026-08-06 | [intermittent decode finding](./findings/2026-08-06-rewrite-kasan-media-suite-userspace-fixes-and-intermittent-h264.md), [lifetime fix and gate](./findings/2026-07-30-ffmpeg-rkmpp-async-frame-lifetime-fix.md), [FFmpeg project](./video-libraries/ffmpeg/README.md) |
...
| 5 | ffmpeg tree | Preserve full-suite ordering and capture per-frame hashes plus MPP frame/slot diagnostics on the first H.264/HEVC mismatch; then install exact Published `c9428bedaa` and repeat the GRD fallback/recreation and AV1 container gates. | [intermittent decode boundary](./findings/2026-08-06-rewrite-kasan-media-suite-userspace-fixes-and-intermittent-h264.md#boundary), [lifetime integration gate](./findings/2026-07-30-ffmpeg-rkmpp-async-frame-lifetime-fix.md#verification-gate) |
