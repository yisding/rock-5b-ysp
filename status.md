...
| 4 | Clean-room rewrite drivers | 🚧 Build `#6` passes the complete 85/85 MPP + 148/148 RGA KUnit plans and binds RGA2 plus both RGA3 cores, but exposes the final two of eight Debug Objects reports across four stack fixtures. Both maintained trees carry all fixture repairs and KUnit/live-service isolation; current tips 6.18 `835b19f81d2b` and mainline `79a804a26e00` additionally move a KASAN-inflated MPP batch fixture off-stack. Fixed-source KASAN/lockdep package `P259b-Cad24` is now built and package-verified with both suites, repaired DTB, and optional DWC PCIe PMU disabled. The targeted 2,928-byte frame warning is gone; 31 other KASAN-inflated KUnit frame-size warnings remain compile-time diagnostics. A warning-clean boot, isolated ABI replay, and media ioctls remain open. | 2026-07-27 | [fixed-source KASAN package](./findings/2026-07-27-rewrite-kasan-fixed-source-package.md), [final capped KUnit fixture](./findings/2026-07-27-rewrite-kunit-final-stack-fixture.md) |
...
| 4 | Clean-room rewrite drivers | Install and boot package-verified `P259b-Cad24` from 6.18 tip `835b19f81d2b`. Require 85/85 MPP plus 148/148 RGA with no debug-object or other fatal report, confirm lockdep remains enabled with the optional DWC PCIe PMU absent, and retain the proven RGA2 + two-RGA3 binding. Then run isolated ABI replay with clean dmesg and readable debugfs before resuming paired counter/artifact conformance. | [package fingerprint and next gate](./findings/2026-07-27-rewrite-kasan-fixed-source-package.md#next-gate), [DWC PCIe PMU warning](./findings/2026-07-26-dwc-pcie-pmu-bus-notifier-lockdep-false-positive.md#qualification-impact), [remaining rewrite hardware gates](./kernel-drivers/docs/rewrite-conformance-gap-audit.md#remaining-gaps-and-hardware-gates) |
