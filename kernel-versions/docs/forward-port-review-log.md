...
defects stay in [bsp-audit.md](../../kernel-drivers/docs/bsp-audit.md) and the AV1-specific BSP defects
stay in [av1-bsp-audit.md](../../kernel-drivers/av1/docs/av1-bsp-audit.md).
...
- The shared-domain CCU design remains the major IOMMU correctness risk. The
  ...
  chosen direction is now tracked in [mpp-ccu-iommu-plan.md](../../kernel-drivers/iommu/docs/mpp-ccu-iommu-plan.md):
...
[mpp-ccu-iommu-plan](../../kernel-drivers/iommu/docs/mpp-ccu-iommu-plan.md)**:
