...
The convert-in-place form ([Armbian packaging guide](../../packaging/docs/armbian-packaging.md)) inherits four things from `media-0001`'s
...
> [device-tree guide § Interrupts](../../kernel-drivers/docs/device-tree.md#interrupts-gic-spi).
>
...
> in-tree — see [device-tree guide](../../kernel-drivers/docs/device-tree.md).)
...
source), see [source-tree pins](../../docs/source-trees.md); the convert-in-place commit is
...
**Read [resyncing guide](../../kernel-drivers/docs/resyncing.md) first** — it is the dedicated resync
...
the **6.18-specific API adaptations** in [forward-port guide](./vendor-forward-port.md),
especially:
...
side changes shape — see [rewrite-driver track § 5](../../kernel-drivers/docs/rewrite-drivers.md).
