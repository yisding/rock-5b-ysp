...
| Clean-room rewrite qualification | [Rewrite architecture](../kernel-drivers/docs/rewrite-driver-architecture/README.md) | [defect audit](2026-07-24-rewrite-driver-multi-agent-defect-audit.md) → [first complete KUnit failures](2026-07-26-rewrite-kunit-failure-root-causes.md) → [boot-lifecycle wedge](2026-07-27-rewrite-kunit-boot-lifecycle-wedge.md) → [fixture/lockdep boundary](2026-07-27-rewrite-reset-import-fixture-lockdep.md) → [rewrite counterfactual](2026-08-01-rewrite-driver-retrospective.md) → [request/rotation repair](2026-08-04-rewrite-kunit-request-rotation-repair.md) → [current rebase/build boundary](2026-08-04-rewrite-kernel-rebase-6-18-42-7-2-rc6.md) | [`status.md` track 4](../status.md) and [rewrite conformance contract](../kernel-drivers/tests/rewrite-conformance.md) |
