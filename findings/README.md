...
- [`2026-08-01-forward-port-uaf-oops-audit-round-2.md`](2026-08-01-forward-port-uaf-oops-audit-round-2.md) — Forward-port UAF/oops audit round 2: 17 defects, 6 of them unprivileged memory corruption
