...
- `` `2026-07-17-rk3588-maximum-mainline-kernel-plan.md` `` — build the broadest auditable RK3588 kernel from upstream v7.2-rc3 plus a manifest-pinned queue of every applicable public queued/sent/RFC proposal, reconcile the RGA3/RKVDEC scheduler and display-stack overlaps instead of blindly stacking them, keep FRL/VP9 proof-of-concept work in a separate WIP profile, and reuse the proven co-installable Armbian image/DTB/headers boot contract while retaining the 6.18 kernel for rollback and vendor-UAPI workloads — CONFIG-INSPECTED / SOURCE-INSPECTED / DESIGN / INFERRED.
