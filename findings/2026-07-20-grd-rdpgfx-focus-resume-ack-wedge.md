...
> Result: cleaned fix `0018@34145d9` builds; its functionally equivalent
> installed `exp6@7e958e6` predecessor fired once and restored hardware frame
> progress in the exact live focus workload.
...
```text
/home/yi/Code/rock-5b/build/gnome/grd-wedge-runs/20260720-0635-focus-ack-wedge/core.8343
```
...
- The live `exp6` focus run fired the real watchdog once at `08:43:39` with
  ...
  preserved at
  `/home/yi/Code/rock-5b/build/gnome/grd-wedge-runs/20260720-exp6-ack-recovery.core`.
