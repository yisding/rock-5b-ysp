...
|---------|--------|-------|
| [`gnome-remote-desktop/`](gnome-remote-desktop/README.md) | The hardware H.264 RDP backend: design, zero-copy capture path, profiling, testing, the 13-patch backend/reconnect series, and the GDM greeter ACL. | [`gnome-remote-desktop/`](gnome-remote-desktop/README.md) |
