...
| Field | Contents |
|-------|----------|
| User outcome | Play H.264/HEVC (and, once the container fix lands, AV1) in Kodi with the RK3588 decoding in hardware — smooth 4K at a few percent CPU. |
...
| **AV1 from mp4/mkv** | fork `av1_rkmpp` drops the container sequence header | ❌ fork bug — works from IVF only |
