...
with the harness in [`apps/gnome-remote-desktop/bench/readback_bench.c`](../bench/readback_bench.c), re-run
...
[`video-libraries/mesa`](../../../video-libraries/mesa).
...
[`apps/gnome-remote-desktop/bench/readback_bench.c`](../bench/readback_bench.c) reproduces the exact operation
