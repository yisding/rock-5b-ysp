...
| Developer focus | Keep the AV1 block, VSI-IOMMU provider, vendor-MPP userspace expectations, and mainline Hantro/V4L2 alternative clearly separated. |
| Owns | [`docs/av1-rk3588.md`](docs/av1-rk3588.md), [`docs/av1-bsp-audit.md`](docs/av1-bsp-audit.md), and [`keywords.md`](keywords.md). |
