...
| Evidence boundary | [`docs/how-rknpu-works.md`](docs/how-rknpu-works.md) and [`docs/kernel-driver-architecture.md`](docs/kernel-driver-architecture.md) own source-inspected behavior, quality, and forward-port boundaries. [`../../docs/support-coverage.md`](../../docs/support-coverage.md) row C16 owns the runtime-assessment gap; status gains a track only if sustained public work begins. |
...
| What are the inspected quality and multi-client boundaries? | [`docs/how-rknpu-works.md`](docs/how-rknpu-works.md#18-quality-and-security-appendix) |
| What would forward-porting the kernel driver take? | [`docs/kernel-driver-architecture.md`](docs/kernel-driver-architecture.md#13-forward-port-boundaries) |
