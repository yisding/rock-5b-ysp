...
resize/convert, legacy RGB resize, Gaussian matrix, sequential IM2D task-job
copy chains, forced-core, pre-intr, async fence-chain, resize, and fill paths.
Its default
