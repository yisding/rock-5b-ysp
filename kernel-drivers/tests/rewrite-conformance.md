...
`../rock-5b/rockchip-conformance/logs/$PROFILE/`. It also scans each official
...
looks like a successful shell exit. A matched fatal line is recorded as
`log-fail`. Its default **required** set includes the in-repo
