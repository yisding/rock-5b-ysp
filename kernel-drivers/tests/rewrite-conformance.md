...
event-harness build, RGA IOMMU scatter-fuzzer build, MPP/GStreamer
case-builder validation, FFmpeg case-list validation, and comparator
maintenance check.
...
smoke build, optional GStreamer event-harness build, IOMMU-fuzzer build, and
MPP case-builder validation
