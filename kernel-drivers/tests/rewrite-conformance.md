...
```bash
VALIDATE_ONLY=1 bash rewrite-conformance-run.sh  # device-free runner/syzlang/case/comparator wiring check
...
now include the syzkaller ABI-marker consistency check in addition to the
runner, case-list, and comparator checks. They were last verified on
2026-07-06 after the syzkaller ABI-marker step was wired into
