...
> | `LIBRGA_SUITE_VALIDATE_LOG_PARSER` | `librga-suite.sh` | set to `1` for the device-free selftest that ensures fatal official-sample log messages override their unreliable zero process status |
