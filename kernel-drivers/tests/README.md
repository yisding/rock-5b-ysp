...
> | `REQUIRED_ZERO_AFTER_COUNTERS` | `debugfs-counter-check.sh` | optional counter specs whose after-run value must be exactly zero, used by the RGA userptr-IOMMU gate for `rga_userptr_iommu:active` |
