...
VALIDATE_ONLY=1 bash rewrite-conformance-run.sh  # device-free runner/syzlang/ioctl-fuzz/librga-smoke/gstreamer-harness/iommu-fuzz/recovery/case/comparator wiring check
