...
> | `LIBRGA_SUITE_VALIDATE_CASES` | `librga-suite.sh` | set to `1` for the device-free default/opt-in vendor-heap case-list selftest; it also keeps `rga_alpha_rgba5551_demo` and `rga_mosaic_demo` excluded because Rockchip librga 1.10.6_[3] rejects them before an ioctl |
