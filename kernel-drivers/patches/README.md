...
| Current state | This directory owns patch deliverables and mechanical application, not the moving series/package verdict. [`status.md`](../../status.md) and W16 own live state; the [forward-port scorecard](../docs/forward-port-status.md) owns accumulated capability evidence; the [patch catalog](../docs/patch-catalog.md) owns provenance/backport classification. The frozen two-patch pair below remains for DKMS and citation provenance, not as a second install choice. |
...
| [`rewrite-cleanup/`](rewrite-cleanup) | Behavior-preserving cleanup patches for the clean-room rewrite drivers, prepared against the byte-identical maintained branch sources. | [`rewrite-cleanup/README.md`](rewrite-cleanup/README.md) |
...
| [`forward-port-rk3588/`](forward-port-rk3588) | The maintained RK3588 MPP/RGA/AV1/IEP2 source series. Its README is the mechanical order/index; W16 identifies the moving tip, the patch catalog owns provenance/backport classification, and the scorecard owns accumulated evidence. Generated `.deb`s and worktrees stay outside git. | [`forward-port-rk3588/README.md`](forward-port-rk3588/README.md), [per-patch provenance/backport catalog](../docs/patch-catalog.md), [scorecard](../docs/forward-port-status.md) |
...
Validation state is deliberately outside this mechanical index. Use the
[forward-port scorecard](../docs/forward-port-status.md) for capability
evidence and the [patch catalog](../docs/patch-catalog.md) for per-fix
provenance/backport and bounded validation classification.
