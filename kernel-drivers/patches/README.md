...
| [`forward-port-rk3588-av1/`](forward-port-rk3588-av1) | Actively maintained 68-file RK3588 MPP/RGA/AV1 forward-port series (`0001`–`0069`, with `0012` omitted). `Pd222-C4ad2` boot-validates through `0058`; `0059`–`0069` port every BSP-audit HIGH still present at that tip and currently have source/compile proof only. This is the PPA/build source line; generated `.deb`s and worktrees stay outside git. | [`forward-port-rk3588-av1/README.md`](forward-port-rk3588-av1/README.md) |
