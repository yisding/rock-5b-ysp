...
| [`forward-port-rk3588-av1/`](forward-port-rk3588-av1) | Actively maintained 44-file RK3588 MPP/RGA/AV1 forward-port series (`0001`–`0045`, with `0012` omitted), including KASAN-derived lifetime fixes `0042`/`0043` and compile-verified RGA ABI fixes `0044`/`0045`. This is the PPA/build source line; generated `.deb`s and worktrees stay outside git. | [`forward-port-rk3588-av1/README.md`](forward-port-rk3588-av1/README.md) |
