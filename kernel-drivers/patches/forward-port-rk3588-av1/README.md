...
`2abc978f92a64` (`v6.18..HEAD`, with `0012`
omitted), matching the 48-file series generated by `build-armbian-deb.sh`.
...
`0048` verification exposed the `0049` UV-offset defect; `0049` is committed
and checkpatch-clean and needs its own booted P010 chroma gate. See the
