...
`8e641bcd48a38` (`v6.18..HEAD`, with `0012`
omitted), matching the 47-file series generated by `build-armbian-deb.sh`.
...
The `0046`–`0048` RGA fixes are committed and checkpatch-clean; they need a
rebuilt booted debug kernel plus the legacy-blit, `EOPNOTSUPP`, and bit-exact
P010 gates. See the
