...
`13c503286f6e2` (`v6.18..HEAD`, with `0012`
...
read back stale destination data: the bounce copy-back post-clean was
wrongly skipped for IOMMU-mapped (default-map-core) origins. `0051` is
amended (`13c503286f6e2`, this snapshot) to key the post-clean on the
bounce direction; the content-exact gate awaits the next debug build. See
the
