...
green only when the named **100 MPP + 152 RGA case manifest** matches without
...
|-------|----------------|
| Inner KTAP plan | exactly 100 MPP or 152 RGA |
...
The maintained tips are now 6.18 `e99b3da2f3318` on `v6.18.42` and mainline
`63bbb63bec44d` on `v7.2-rc6`, with an exact 100/152 manifest. Predecessor 6.18
...
repair after the 2026-08-04 rebases. The eight newer MPP cases cover the
reset-domain, cluster construction, group-reset, CCU ownership, and typed
single-core recovery checkpoints added in Phase 2. Both current tips pass
