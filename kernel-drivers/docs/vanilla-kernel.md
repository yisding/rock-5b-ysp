...
> [device-tree guide § Interrupts](./device-tree.md#interrupts-gic-spi).
>
...
> in-tree — see [device-tree guide](./device-tree.md).)
...
**Read [resyncing guide](./resyncing.md) first** — it is the dedicated resync
...
side changes shape — see [rewrite-driver track § 5](./rewrite-drivers.md).
