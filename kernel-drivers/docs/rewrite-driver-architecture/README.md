...
| Target ownership | the MPP cluster exists as a shadow topology object; MPP activation and RGA task-execution/acquire-set objects, plus cluster admission/recovery authority, remain refactor goals rather than current behavior claims |
