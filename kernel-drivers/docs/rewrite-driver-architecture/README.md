...
| Target ownership | the MPP cluster owns topology and hard-CCU reset-pulse validation; MPP activation and RGA task-execution/acquire-set objects, plus cluster power/admission/full-recovery authority, remain refactor goals rather than current behavior claims |
