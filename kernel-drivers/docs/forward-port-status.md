...
- **The board's prebuilt `/usr/lib` `librockchip_mpp` cannot drive these
  ...
  MPP build works: `mpi_dec_test` linked against `../rock-5b/rockchip-conformance`'s
