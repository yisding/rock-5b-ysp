...
| RGA2 high USERPTR mapping | Installed 6.18.43/`0092` fails three RGA2-only official librga samples before hardware start when merged 2 MiB entries exceed SWIOTLB's per-map ceiling; `0093` is compile-verified and needs package/boot replay |
