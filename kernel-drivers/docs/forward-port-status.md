...
| Patch `0094` | The same 256 KiB constraint cannot be repaired by splitting exporter-owned DMA-BUF attachment tables. The [source fix](../../findings/2026-08-08-forward-port-rga2-dmabuf-staging.md) prefers compatible RGA3 work, stages bounded RGA2-only buffers through shared DMA32 pages after exact `-EIO`, and is strict-checkpatch/full-driver compile-verified with package/boot replay pending |
