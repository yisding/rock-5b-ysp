...
companion to [mainline-rkvdec-v4l2.md](./mainline-rkvdec-v4l2.md) (read that
first) and complements the **vendor** stack's already-solved multi-core treatment
in [how-the-drivers-work.md § 7](./how-the-drivers-work.md).
...
([mainline-rkvdec-v4l2.md § 6c](./mainline-rkvdec-v4l2.md)).
...
1. **Even Rockchip defaults to SOFT; HARD is effectively unvalidated** ("doesn't
   ...
   the vendor themselves avoid, on closed silicon.
