...
stack in [how-the-drivers-work.md](./how-the-drivers-work.md)). This doc exists
...
[multicore-scheduling.md](./multicore-scheduling.md) legible. Each concept opens
...
> `rk3588-rewrite-mainline` branch (local checkout `/home/yi/Code/linux`,
...
> [how-the-drivers-work.md](./how-the-drivers-work.md) and
...
- [multicore-scheduling.md](./multicore-scheduling.md) — the mem2mem scheduler,
  the multi-core design space, the Collabora multicore series, and the CCU
  hard/soft analysis. This doc is its prerequisite.
- [how-the-drivers-work.md](./how-the-drivers-work.md) — the **vendor MPP** decode
