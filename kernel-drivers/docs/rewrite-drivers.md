...
> acquire/release fences, and per-core scheduler counters. MPP applies DT
...
| Size (observed 2026-07-03) | MPP ~15,822 lines + RGA3 ~19,171 lines (vendor-delta.md method) | MPP rewrite ~8,672 lines + RGA rewrite ~17,008 lines |
