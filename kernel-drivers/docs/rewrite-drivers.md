...
> submission, forced RGA2 `IM_PRE_INTR`, and an async acquire/release-fence
> chain, but these still need to be run on a booted rewrite kernel. The shipped,
