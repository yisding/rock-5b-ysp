...
| Size (observed 2026-07-04) | MPP ~15,822 lines + RGA3 ~19,171 lines (vendor-delta.md method) | MPP rewrite ~8,910 lines + RGA rewrite ~17,304 lines |
