...
| Size (observed 2026-07-03) | MPP ~15,822 lines + RGA3 ~19,171 lines (vendor-delta.md method) | MPP rewrite ~8,817 lines + RGA rewrite ~17,355 lines |
...
- **Userspace-visible priorities after the packed-YUV420 fill slice** are
  ...
  color-convert, and 0/90/180/270-degree rotation.  The highest-value MPP
