...
| Size (observed 2026-07-03) | MPP ~15,822 lines + RGA3 ~19,171 lines (vendor-delta.md method) | MPP rewrite ~8,282 lines + RGA rewrite ~15,166 lines |
...
- Optional **KUnit coverage** exists on both rewrite drivers: MPP parser helpers
  ...
  request staging, legacy async blit and modern async request-submit
