...
| Size (observed 2026-07-06) | MPP ~15,822 lines + RGA3 ~19,171 lines (vendor-delta.md method) | MPP rewrite ~9,256 lines + RGA rewrite ~18,192 lines |
