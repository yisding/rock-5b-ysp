...
> acquire/release fences, OSD external colors, and per-core scheduler counters. MPP applies DT
...
| Size (observed 2026-07-03) | MPP ~15,822 lines + RGA3 ~19,171 lines (vendor-delta.md method) | MPP rewrite ~8,672 lines + RGA rewrite ~17,039 lines |
...
- **Per-core profile coverage** (what real librga/ffmpeg consumers need):
  ...
  - **RGA2**: solid fill, YUV fill including packed YUV422 destination
    ...
    commands including BPP1/2/4/8 sources.
