...
> `librga` smoke now covers virtual-address imports, sync copy/resize/fill,
> forced RGA3 core-mask + priority submission, forced RGA2 `IM_PRE_INTR`, and an async
