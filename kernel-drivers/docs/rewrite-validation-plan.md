...
> **96 cases / 1,613 assertions** at the §6 pins (`484f30b7fcb6` on 6.18,
> `3913f2068f8f` on mainline). But every one of those tests is **logic-level**:
...
1. 147 KUnit cases green **under KASAN**; hardware-in-the-loop kselftests added
