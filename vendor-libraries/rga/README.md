...
| Current state | Scale/color-convert validated through FFmpeg; the P010/P210 fix needs hardware validation and is **not yet exported in-repo** (dev-box `../librga-src` only). See [`../../status.md`](../../status.md). |
